...
public class NetDetectionActivity extends Activity implements View.OnClickListener{
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_TXOK:
                    ...
                    //跳转到测试结果界面
                    Intent intent = new Intent(NetDetectionActivity.this,TestReportActivity.class);
    ...
    private void downloadFile(){
        ...
        final String url = "http://192.168.241.120:8080//filemanage/download?filename=" +
    ...
    public void fileupload() {
        ...
        Request request = new Request.Builder()
                .url("http://192.168.241.120:8080//filemanage/uploadFile")
                .post(requestBody)
                .build();
